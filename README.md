...
> Это моя версия оригинального проекта [Koalal143/food-social-network](https://github.com/Koalal143/food-social-network)

### Почему этот репозиторий существует?
- Я работал над проектом полгода назад
- Коммиты были сделаны под email `you@example.com`
- Переписал авторство, чтобы коммиты учитывались в моей активности GitHub

### Что было сделано:
- Исправлено авторство в 396 коммитах
- Вся история разработки сохранена
...
Этот проект создан с особой заботой о качестве кода, производительности и пользовательском опыте.
