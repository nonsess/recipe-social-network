...
export default function MobileMenu() {
    ...
    return (
        <Container className="md:hidden fixed bottom-0 left-0 right-0 bg-background border-t flex justify-around py-2 z-50">
            <Link href="/" passHref>
                <Button variant="ghost" size="icon" className={`flex flex-col items-center ${isActive('/') ? 'text-primary' : 'text-muted-foreground'}`}>
            ...
            <Link href="/recommendations" passHref>
                <Button variant="ghost" size="icon" className={`flex flex-col items-center ${isActive('/recommendations') ? 'text-primary' : 'text-muted-foreground'}`}>
            ...
            <Link href="/profile" passHref>
                <Button variant="ghost" size="icon" className={`flex flex-col items-center ${isActive('/profile') ? 'text-primary' : 'text-muted-foreground'}`}>
