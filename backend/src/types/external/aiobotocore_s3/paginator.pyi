...
if TYPE_CHECKING:
    _ListBucketsPaginatorBase: TypeAlias = AioPaginator[ListBucketsOutputTypeDef]
else:
...
if TYPE_CHECKING:
    _ListDirectoryBucketsPaginatorBase: TypeAlias = AioPaginator[ListDirectoryBucketsOutputTypeDef]
else:
...
if TYPE_CHECKING:
    _ListMultipartUploadsPaginatorBase: TypeAlias = AioPaginator[ListMultipartUploadsOutputTypeDef]
else:
...
if TYPE_CHECKING:
    _ListObjectVersionsPaginatorBase: TypeAlias = AioPaginator[ListObjectVersionsOutputTypeDef]
else:
...
if TYPE_CHECKING:
    _ListObjectsPaginatorBase: TypeAlias = AioPaginator[ListObjectsOutputTypeDef]
else:
...
if TYPE_CHECKING:
    _ListObjectsV2PaginatorBase: TypeAlias = AioPaginator[ListObjectsV2OutputTypeDef]
else:
...
if TYPE_CHECKING:
    _ListPartsPaginatorBase: TypeAlias = AioPaginator[ListPartsOutputTypeDef]
else:
