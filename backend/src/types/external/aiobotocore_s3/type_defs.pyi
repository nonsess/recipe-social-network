...
TimestampTypeDef: TypeAlias = datetime | str
...
BlobTypeDef: TypeAlias = str | bytes | IO[Any] | StreamingBody
...
FileobjTypeDef: TypeAlias = IO[Any] | StreamingBody
...
CopySourceOrStrTypeDef: TypeAlias = str | CopySourceTypeDef
...
CORSRuleUnionTypeDef: TypeAlias = CORSRuleTypeDef | CORSRuleOutputTypeDef
CloudFunctionConfigurationUnionTypeDef: TypeAlias = CloudFunctionConfigurationTypeDef | CloudFunctionConfigurationOutputTypeDef
...
QueueConfigurationDeprecatedUnionTypeDef: TypeAlias = QueueConfigurationDeprecatedTypeDef | QueueConfigurationDeprecatedOutputTypeDef
...
TopicConfigurationDeprecatedUnionTypeDef: TypeAlias = TopicConfigurationDeprecatedTypeDef | TopicConfigurationDeprecatedOutputTypeDef
LifecycleExpirationUnionTypeDef: TypeAlias = LifecycleExpirationTypeDef | LifecycleExpirationOutputTypeDef

class DeleteTypeDef(TypedDict):
    Objects: Sequence[ObjectIdentifierTypeDef]
    Quiet: NotRequired[bool]

ObjectLockRetentionUnionTypeDef: TypeAlias = ObjectLockRetentionTypeDef | ObjectLockRetentionOutputTypeDef
TransitionUnionTypeDef: TypeAlias = TransitionTypeDef | TransitionOutputTypeDef
...
LifecycleRuleAndOperatorUnionTypeDef: TypeAlias = LifecycleRuleAndOperatorTypeDef | LifecycleRuleAndOperatorOutputTypeDef
...
S3KeyFilterUnionTypeDef: TypeAlias = S3KeyFilterTypeDef | S3KeyFilterOutputTypeDef
...
OwnershipControlsUnionTypeDef: TypeAlias = OwnershipControlsTypeDef | OwnershipControlsOutputTypeDef
...
TargetObjectKeyFormatUnionTypeDef: TypeAlias = TargetObjectKeyFormatTypeDef | TargetObjectKeyFormatOutputTypeDef
...
ServerSideEncryptionConfigurationUnionTypeDef: TypeAlias = ServerSideEncryptionConfigurationTypeDef | ServerSideEncryptionConfigurationOutputTypeDef
...
RuleUnionTypeDef: TypeAlias = RuleTypeDef | RuleOutputTypeDef
...
IntelligentTieringConfigurationUnionTypeDef: TypeAlias = IntelligentTieringConfigurationTypeDef | IntelligentTieringConfigurationOutputTypeDef
...
LifecycleRuleFilterUnionTypeDef: TypeAlias = LifecycleRuleFilterTypeDef | LifecycleRuleFilterOutputTypeDef
...
MetricsConfigurationUnionTypeDef: TypeAlias = MetricsConfigurationTypeDef | MetricsConfigurationOutputTypeDef
...
NotificationConfigurationFilterUnionTypeDef: TypeAlias = NotificationConfigurationFilterTypeDef | NotificationConfigurationFilterOutputTypeDef
...
LoggingEnabledUnionTypeDef: TypeAlias = LoggingEnabledTypeDef | LoggingEnabledOutputTypeDef
...
AnalyticsConfigurationUnionTypeDef: TypeAlias = AnalyticsConfigurationTypeDef | AnalyticsConfigurationOutputTypeDef
...
InventoryConfigurationUnionTypeDef: TypeAlias = InventoryConfigurationTypeDef | InventoryConfigurationOutputTypeDef

class GetBucketReplicationOutputTypeDef(TypedDict):
    ReplicationConfiguration: ReplicationConfigurationOutputTypeDef
    ResponseMetadata: ResponseMetadataTypeDef

ReplicationConfigurationUnionTypeDef: TypeAlias = ReplicationConfigurationTypeDef | ReplicationConfigurationOutputTypeDef
...
LifecycleRuleUnionTypeDef: TypeAlias = LifecycleRuleTypeDef | LifecycleRuleOutputTypeDef
...
LambdaFunctionConfigurationUnionTypeDef: TypeAlias = LambdaFunctionConfigurationTypeDef | LambdaFunctionConfigurationOutputTypeDef
QueueConfigurationUnionTypeDef: TypeAlias = QueueConfigurationTypeDef | QueueConfigurationOutputTypeDef
TopicConfigurationUnionTypeDef: TypeAlias = TopicConfigurationTypeDef | TopicConfigurationOutputTypeDef
